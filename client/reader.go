...
func blockForPos(offset uint64, inode *ino.Inode) (blk ino.Block, err error) {
	...
	return ino.Block{}, errors.New(fmt.Sprintf("offset %d not found in any blocks for inode %d, bad file?", offset, inode.Inodeid))
