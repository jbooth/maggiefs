...
func (_c *NameServiceClient) SetAttr(nodeid uint64, arg SetAttr) (newNode *Inode, err error) {
...
func (_c *NameServiceClient) Truncate(nodeid uint64, newLen uint64) (newNode *Inode, err error) {
...
func (_c *NameServiceClient) AddBlock(nodeid uint64, blockStartPos uint64, requestedDnId *uint32) (newNode *Inode, err error) {
